...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AD PrivEsc Lab — Privilege escalation por firma" },
      {
        name: "description",
        content:
          "Lab visual local para aprender privilege escalation en Windows/AD: Se*, Kerberos, ACL. Solo labs autorizados.",
      },
      { name: "author", content: "AD PrivEsc Lab" },
      { property: "og:title", content: "AD PrivEsc Lab — Privilege escalation por firma" },
      {
      ...
      { name: "twitter:title", content: "AD PrivEsc Lab — Privilege escalation por firma" },
      {
