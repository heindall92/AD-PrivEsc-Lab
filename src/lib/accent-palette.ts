...
export const ACCENT_PALETTE: Record<AccentId, { dark: AccentThemeTokens; light: AccentThemeTokens }> = {
  blue: {
    dark: {
      swatch: "oklch(0.72 0.19 230)",
      primary: "oklch(0.72 0.19 230)",
      primaryForeground: "oklch(0.12 0.03 230)",
      ring: "oklch(0.72 0.19 230)",
      accent: "oklch(0.68 0.16 210)",
      accentForeground: "oklch(0.12 0.03 210)",
      electric: "oklch(0.74 0.18 250)",
      glow: "oklch(0.72 0.19 230 / 0.45)",
    },
    light: {
      swatch: "oklch(0.52 0.2 230)",
      primary: "oklch(0.52 0.2 230)",
      primaryForeground: "oklch(0.99 0.01 230)",
      ring: "oklch(0.52 0.2 230)",
      accent: "oklch(0.5 0.16 210)",
      accentForeground: "oklch(0.99 0.01 210)",
      electric: "oklch(0.55 0.2 250)",
      glow: "oklch(0.52 0.2 230 / 0.35)",
    },
  },
  green: {
    dark: {
